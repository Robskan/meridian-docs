...
| Color | Meaning |
| :-: | --- |
| <Badge color="blue" stroke>L</Badge> | This is a possible position. You can try placing a component here. |
  ...
  <Tab title="Options">
    <Columns cols={2}>
      <Column>
        ...
        - The Label
        - The Value
        - The Description <Badge>o</Badge>
        - The Emoji <Badge>Optional</Badge>

        <Badge color="orange" stroke icon="traffic-cone" /> Soon, you'll be able to rearrange options.
      </Column>
      <Column>
        <Frame>
