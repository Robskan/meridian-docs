...
## Manage an applicManage an application

Each application has three tabs.Each application has three tabs.
...
All applications require a client secret. Public clients are not supportedAll applications require a client secret. Public clients are not supported.
...
**Revoke application** permanently disables the app, removes all user authorizations, and invalidates outstanding tokens. Revocation requires PIN or passkey confirmation**Revoke application** permanently disables the app, removes all user authorizations, and invalidates outstanding tokens. Revocation requires PIN or passkey confirmation.
