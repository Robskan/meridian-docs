...
Only API requests sent to third-party services are billed. This means requests to Discord or partnered services are free to use. Included billed types below use 3 Power each run:
