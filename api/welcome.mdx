...
<Columns cols={2}>
  <Column>
    <Card title="OAuth API" icon="key">
      Authorization code flow for third-party apps that act on a user's account.
    </Card>
  </Column>
  <Column>
    <Card title="And so much more" icon="menu">
      Utilize the Meridian API to control your bots from third party apps easily.
    </Card>
  </Column>
</Columns>
