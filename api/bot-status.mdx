...
In the bot's settings, turn on the **public status API**. Until that flag is on, requests return `404`.

Prefer the bot's **Discord id** in the URL (17–20 digit snowflake). Convex bot ids also work.
